...
u1 = User.create({name: "David Hayward", username: "davidhayward", email: "david.hayward@inter-act.co.uk", password: "changeme", password_confirmation: "changeme", role_id: r2.id})